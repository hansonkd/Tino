...
## MessagePack as a Serialization
...
MessagePack paired with RESP means that you can implement the entire stack, protocol and seriialization, by yourself from scratch if you needed to without too much trouble. And it will be fast.
...
Its not ready for public consumption at the moment, but if you want help to run it, just drop me a line.
